...
class TmdbTabBarViewModelTests: XCTestCase {
    ...
    func testTabBarItems_should_contain_watchNow_search_in_order() throws {
        // This is an example of a functional test case.
        // Use XCTAssert and related functions to verify your tests produce the correct results.
        let sut: [TmdbTabBarViewModel.Item] = viewModel.items.value
        
        let requiredOrder: [TmdbTabBarViewModel.Item] = [TmdbTabBarViewModel.Item.watchNow,
    ...
    func testTabBarItems_should_have_expected_title_for_trending_nowPlaying_search() throws {
        ...
        let requiredOrder: [String] = ["Watch Now", "Search"]
